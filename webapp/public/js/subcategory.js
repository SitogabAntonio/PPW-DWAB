...
const community = [
    {
        ...
        title: "Hiking Sumut",
        description:
            "Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque mollitia similique officiis perferendis excepturi adipisci, aut ipsam doloribus quibusdam accusantium nobis ducimus asperiores sapiente deserunt? Amet, veniam soluta nemo sint eveniet suscipit. Dolorum minima, quam obcaecati aperiam explicabo reiciendis dolorem doloribus nulla animi qui porro molestias labore dolore voluptatem similique? Fugiat provident corrupti hic repudiandae inventore pariatur minus accusantium eaque culpa nemo natus, numquam repellat!",
        category: "TRAVEL",
    },
    {
        id: 3,
...
function displayItem(items) {
    ...
    items.forEach(item => {
        ...
        const itemContent = `
            ...
            <div class='bottom'>
                <a href='https://wa.me/6282297422654' target='_blank'>
