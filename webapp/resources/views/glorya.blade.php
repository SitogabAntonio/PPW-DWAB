...
<body>
    ...
    <div class="container">
        ...
        <section class="userProfile card" id='profile'>
            <div class="profile">
                <figure><img src="image/glory.jpg" alt="profile" width="250px" height="250px"></figure>
                <button class="edit-button" id="friend-button" onclick="changeButtonText()">Add Friend</button>
            </div>
        </section>
        ...
        <section class="userDetails card">
            <div class="userName">
                <h1 class="name">Glorya Sembiring</h1>
                <div class="map">
